//
//program: asteroids_fullscreen.cpp (full-screen edition)
//author:  Gordon Griesel
//date:    2014 - 2024
//mod spring 2015: added constructors
//mod spring 2018: added full-screen X11 constructor
//                       command-line arguments
//                       mod to check_mouse
//mod spring 2020: distributed the X11_wrapper class
//This program is a game starting point for a 3350 project.
//
// Important features of this project
//
//  1. Ability for full-screen X11 window.
//     No title bar or borders.
//
//  2. Ability to set the mouse cursor position.
//
//  3. Steady physics rate regardless of frame-rate.
//
//  4. Frame rate displayed.
//
//  5. Multiple simultaneous key presses handled.
//
//  6. Vsync control.
//
//
...
//for windowed
//X11_wrapper x11(800,600);

//function prototypes
void init_opengl(void);
void check_mouse(XEvent *e, X11_wrapper *x11);
...
//---start of X11 class member functions...
...
void X11_wrapper::initX11(int w, int h) {
...
//---end of X11 class member functions
...
int check_keys(XEvent *e)
{
	...
	switch (key) {
		...
		case XK_f: {
                       system("xrandr --output HDMI-1 --mode 800x600");
			break;
        }
		case XK_s:
			break;
...
void render()
{
	...
	r.left = 10;
	r.center = 0;
	ggprint8b(&r, 16, 0x00ff0000, "4490 - Asteroids full-screen");
	ggprint8b(&r, 16, 0x00ffff00, "n bullets: %i", g.nbullets);
	ggprint8b(&r, 16, 0x00ffff00, "n asteroids: %i", g.nasteroids);
	ggprint8b(&r, 16, 0x00ffff00, "vsync: %s", ((gl.vsync)?"ON":"OFF"));
	ggprint8b(&r, 16, 0x00ffff00, "fps: %i", gl.fps);
	//-------------------------------------------------------------------------
	//Draw the ship
