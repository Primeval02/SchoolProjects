...
int main()
{
	...
	while (!done) {
        ...
        //how long since physics last called
        //if longer than physics rate
        //
        //call physics 59 times
        //
        //while(timediff > physics_rate) {
            //physics();
            //timediff -= physics_rate;
        //}
        //
        //
        //if shorter than physics rate
        //
        //call physics ? times
        //dont call physics yet
        //
        //
		physics();  //move things
		render();   //draw things
