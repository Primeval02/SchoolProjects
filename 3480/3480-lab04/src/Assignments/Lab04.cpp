...
void Transform2D::renderUI() {
	ImGui::InputFloat3("Translate", glm::value_ptr(translation));
	ImGui::InputFloat3("Rotation center", glm::value_ptr(rotation));
	ImGui::SliderFloat("Rotation", &rotation.w, 0.0f, glm::two_pi<float>());
	renderEnumDropDown("Rotation axis", axis);
	ImGui::Checkbox("Auto-spin", &autoSpin);
	ImGui::Checkbox("Auto-fall", &autoFall);
