...
void Lab06::renderUI() {
	...
	if (ImGui::CollapsingHeader("Camera")) {
		ImGui::SliderFloat3("Position", glm::value_ptr(lab06Camera.cameraPosition), -100, 100);
		ImGui::InputFloat3("Position manual", glm::value_ptr(lab06Camera.cameraPosition));
		ImGui::SliderFloat3("Lookat", glm::value_ptr(lab06Camera.cameraLookat), -100, 100);
		ImGui::InputFloat3("Lookat manual", glm::value_ptr(lab06Camera.cameraLookat));
		ImGui::InputFloat3("Up", glm::value_ptr(lab06Camera.cameraUp));
		ImGui::SliderFloat("FOVY", &lab06Camera.cameraFOVY, 0, 360);
		ImGui::InputFloat2("Near-far", glm::value_ptr(lab06Camera.nearFar));

		if (ImGui::Button(lab06Camera.cameraOrtho ? "Orthographic" : "Perspective")) {
			lab06Camera.cameraOrtho = !lab06Camera.cameraOrtho;
		}
	}
